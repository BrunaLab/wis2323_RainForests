...
icon: calendar-alt
icon_pack: fas
linktitle: Weekly Schedule & Assignments
summary: schedule and assignmed readings / videos for the class
title: Weekly Schedule & Assignments 
type: book
weight: 60
---

SCHEDULE & READINGS LINKS
<!-- # Syllabus
 
The complete and updated course syllabus can be downloaded {{% staticref "syllabus/IDS2935_RainForests.pdf" "newtab" %}}here{{% /staticref %}}.
