...
icon<-c(
  "./syllabus_sections/icons/headphones-wt.png",
  "./syllabus_sections/icons/thumbs-up-wt.png",
  "./syllabus_sections/icons/scale-balanced-wt.png",
  "./syllabus_sections/icons/person-breastfeeding-wt.png",
  "./syllabus_sections/icons/computer-wt.png",
  "./syllabus_sections/icons/microphone-wt.png",
  "./syllabus_sections/icons/check-wt.png"
  )
...
tbl_img <- data.frame(
logo = c("\\includegraphics[valign=T,scale=.5,raise=7mm]{./syllabus_sections/icons/headphones-wt.png}"),
# policy = p1,
text=t1
)
tbl_img %>%
...
# https://tex.stackexchange.com/questions/397708/package-xkeyval-error-valign-undefined-in-families-gin
tbl_img <- data.frame(
logo = c("\\includegraphics[valign=T,scale=.5,raise=7mm]{./syllabus_sections/icons/thumbs-up-wt.png}"),
# policy = p2,
text=t2
)
...
# https://tex.stackexchange.com/questions/397708/package-xkeyval-error-valign-undefined-in-families-gin
tbl_img <- data.frame(
logo = c("\\includegraphics[valign=T,scale=.5,raise=7mm]{./syllabus_sections/icons/scale-balanced-wt.png}"),
# policy = p3,
text=t3
)
tbl_img %>%
...
# https://tex.stackexchange.com/questions/397708/package-xkeyval-error-valign-undefined-in-families-gin
tbl_img <- data.frame(
logo = c("\\includegraphics[valign=T,scale=.5,raise=7mm]{./syllabus_sections/icons/computer-wt.png}"),
# policy = p6,
text=t6
)
tbl_img %>%
...
# https://tex.stackexchange.com/questions/397708/package-xkeyval-error-valign-undefined-in-families-gin
tbl_img <- data.frame(
logo = c("\\includegraphics[valign=T,scale=.5,raise=7mm]{./syllabus_sections/icons/check-wt.png}"),
# policy = p7,
text=t7
)
tbl_img %>%
...
<!-- # https://tex.stackexchange.com/questions/397708/package-xkeyval-error-valign-undefined-in-families-gin -->
<!-- tbl_img <- data.frame( -->
<!-- logo = c("\\includegraphics[valign=T,scale=.5,raise=7mm]{./syllabus_sections/icons/person-breastfeeding-wt.png}"), -->
<!-- # policy = p4, -->
<!-- text=t4 -->
<!-- ) -->
<!-- tbl_img %>% -->
...
# https://tex.stackexchange.com/questions/397708/package-xkeyval-error-valign-undefined-in-families-gin
tbl_img <- data.frame(
logo = c("\\includegraphics[valign=T,scale=.5,raise=7mm]{./syllabus_sections/icons/microphone-wt.png}"),
# policy = p5,
text=t5
)
tbl_img %>%
