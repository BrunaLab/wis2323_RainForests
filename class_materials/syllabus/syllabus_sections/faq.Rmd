...
p3<- c("\\color{black}What works should we do \\textit{before} class?")
...
# icon<-c(
#   "./syllabus_sections/icons/envelope-circle-check.png",
#   "./syllabus_sections/icons/mug-saucer.png",
# "./syllabus_sections/icons/bullhorn.png",
# "./syllabus_sections/icons/house-user.png",
# "./syllabus_sections/icons/person-chalkboard.png",
# "./syllabus_sections/icons/volume-xmark.png",
# "./syllabus_sections/icons/calendar-check.png",
# "./syllabus_sections/icons/calendar-xmark.png",
# "./syllabus_sections/icons/calendar-plus.png"
# )
...
tbl_img <- data.frame(
logo = c("\\includegraphics[valign=T,scale=.4,raise=6mm]{./syllabus_sections/icons/envelope-circle-check.png}"),
policy = p0,
text=t0
)
tbl_img %>%
...
# https://tex.stackexchange.com/questions/397708/package-xkeyval-error-valign-undefined-in-families-gin
tbl_img <- data.frame(
logo = c("\\includegraphics[valign=T,scale=.4,raise=6mm]{./syllabus_sections/icons/mug-saucer.png}"),
policy = p1,
text=t1
)
tbl_img %>%
...
# https://tex.stackexchange.com/questions/397708/package-xkeyval-error-valign-undefined-in-families-gin
tbl_img <- data.frame(
  logo = c("\\includegraphics[valign=T,scale=.4,raise=6mm]{./syllabus_sections/icons/bullhorn.png}"),
policy = p2,
text=t2
)
tbl_img %>%
...
# https://tex.stackexchange.com/questions/397708/package-xkeyval-error-valign-undefined-in-families-gin
tbl_img <- data.frame(
logo = c("\\includegraphics[valign=T,scale=.4,raise=6mm]{./syllabus_sections/icons/house-user.png}"),
policy = p3,
text=t3
)
...
# https://tex.stackexchange.com/questions/397708/package-xkeyval-error-valign-undefined-in-families-gin
tbl_img <- data.frame(
logo = c("\\includegraphics[valign=T,scale=.4,raise=6mm]{./syllabus_sections/icons/person-chalkboard.png}"),
policy = p4,
text=t4
)
...
<!-- # https://tex.stackexchange.com/questions/397708/package-xkeyval-error-valign-undefined-in-families-gin -->
<!-- tbl_img <- data.frame( -->
<!-- logo = c("\\includegraphics[valign=T,scale=.4,raise=6mm]{./syllabus_sections/icons/calendar-check.png}"), -->
<!-- policy = p6, -->
<!-- text=t6 -->
<!-- ) -->
...
# https://tex.stackexchange.com/questions/397708/package-xkeyval-error-valign-undefined-in-families-gin
tbl_img <- data.frame(
logo = c("\\includegraphics[valign=T,scale=.4,raise=6mm]{./syllabus_sections/icons/calendar-xmark.png}"),
policy = p7,
text=t7
)
...
# https://tex.stackexchange.com/questions/397708/package-xkeyval-error-valign-undefined-in-families-gin
tbl_img <- data.frame(
logo = c("\\includegraphics[valign=T,scale=.4,raise=6mm]{./syllabus_sections/icons/calendar-plus.png}"),
policy = p8,
text=t8
)
tbl_img %>%
...
# https://tex.stackexchange.com/questions/397708/package-xkeyval-error-valign-undefined-in-families-gin
tbl_img <- data.frame(
logo = c("\\includegraphics[valign=T,scale=.4,raise=6mm]{./syllabus_sections/icons/volume-xmark.png}"),
policy = p5,
text=t5
)
...
# https://tex.stackexchange.com/questions/397708/package-xkeyval-error-valign-undefined-in-families-gin
tbl_img <- data.frame(
logo = c("\\includegraphics[valign=T,scale=.4,raise=6mm]{./syllabus_sections/icons/person-breastfeeding-wt.png}"),
policy=p9,
text=t9
)
