...
class_location<-c("Locations",class_loc,"")
prof<-as_tibble(prof)
ta<-as_tibble(ta)
...
course_info %>%
  ...
  row_spec(1,bold=T,background="white", color = "darkmidnightblue") %>%
...
```{r graph2, echo=FALSE,message = FALSE,warning=FALSE, out.width = '92%',fig.align="center" }
