...
```{r, child=c('./syllabus_sections/course_outline.Rmd','./syllabus_sections/faq.Rmd','./syllabus_sections/readings.Rmd','./syllabus_sections/policies.Rmd','./syllabus_sections/slos.Rmd','./syllabus_sections/assignment_overview.Rmd')}
```

<!-- './syllabus_sections/course_outline.Rmd', -->
<!-- # './syllabus_sections/quest.Rmd' -->


<!-- ```{r, child=c('./syllabus_sections/course_outline.Rmd','./slo/sl_objectives.Rmd','./slo/slo_secondary.Rmd','./slo/sl_outcomes.Rmd','./slo/sl_outcomes_secondary.Rmd')} -->
<!-- ``` -->
