...
```{r ridges_image, echo=FALSE, include=TRUE, out.width = '80%', fig.align="center" }
...
# Semester Overview & Key Dates _(revised following Hurricane Idalia)_
\vspace{0.0cm}
<!-- \captionsetup[table]{labelformat=empty} -->
...
calendar <- read_csv("./schedule_hurricane.csv") %>% 
