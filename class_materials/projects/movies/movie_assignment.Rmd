...
## Assignment Overview
\vspace{0.3cm}
Your assignment is to watch **three** films set in tropical rain forests and review how the rain forest setting is presented and advances the films' narrative. Your review should _not_ be a summary of the film and it's plot (i.e., a *descriptive review*) or an overall judgment of whether the film is "good" or "bad" (i.e.,  an *evaluative review*). **For your review of each film you should:** 

1. Document the tropes about rain forests used in each film (using the _Trope Checklist_), and  
...
You can download the Trope Checklist as a [pdf here]() or as a [MS Excel File here](). You can [download the list and definitions of tropes here]().
## Films to Review
\vspace{0.3cm}

1. _**The African Queen**_ (1951)

  > In WWI East Africa, a gin-swilling Canadian riverboat captain is persuaded by a strait-laced English missionary to undertake a trip up a treacherous river and use his boat to attack a German gunship. _(Starring Humphrey Bogart & Katharine Hepburn; Directed by John Huston)_.

2. _**Anaconda**_ (1997)

  > When a documentary crew traveling through the Amazon jungle picks up a stranded man, they have no idea it will lead them face-to-face with the world's largest - and deadliest - snake. _(Starring Jon Voight, Jennifer Lopez, Eric Stoltz, Ice Cube, and Owen Wilson; Directed by Luis Llosa)_.


3. _**One movie of your choice**_ from this list.
