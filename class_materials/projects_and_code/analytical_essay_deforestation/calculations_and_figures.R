...
brazil_2000<- read.csv("./class_materials/projects_and_code/analytical_essay_deforestation/brazil/treecover_extent_2000__ha.csv") 
brazil_loss<- read.csv("./class_materials/projects_and_code/analytical_essay_deforestation/brazil/treecover_loss__ha.csv") %>% 
...
indonesia_2000<- read.csv("./class_materials/projects_and_code/analytical_essay_deforestation/indonesia/treecover_extent_2000_in_primary_forests_2001_tropics_only__ha.csv") 
indonesia_loss<- read.csv("./class_materials/projects_and_code/analytical_essay_deforestation/indonesia/treecover_loss_in_primary_forests_2001_tropics_only__ha.csv") %>% 
  rename(year=umd_tree_cover_loss__year,
         loss=umd_tree_cover_loss__ha) %>% 
