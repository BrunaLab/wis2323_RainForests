...
1. She liked the idea of how quantifying how "trope-ey" the movies were. One possibility of a class activity afterwards would be to put movies on a gradient of trope-iness, perahps with some discussion about themovies we all saw and then students can place the one they chose to watch on a gradient. Maybe to get at this have people fill out a matrix in which they fill out some information about the movies (how they depict people, situations, the forest, etc). they can use the "ndex score" to rank their movies. In class the students can explain to the other styiudents why they put the movie they watched on the axis. 
...
## Assignment Overview
\vspace{0.3cm}
Your assignment is to watch **three** films set in tropical rain forests and review how the rain forest setting is presented and advances the films' narrative. Your review should _not_ be a summary of the film and its plot (i.e., a *descriptive review*) or an overall judgment of whether the film is "good" or "bad" (i.e., an *evaluative review*). **For each film need to do the following:** 
