...
# 
# movies <- readxl::read_excel("~/Dropbox (UFL)/Teaching/IDS 2935 - Future of Rain Forests/IDS2935_RainForests/class_materials/projects_and_code/movies/movies.xlsx") %>% 
...
# FOR PDF
  ...
  pack_rows("EXTRA CREDIT: These are so bad you get 5 extra points for watching them", ec_first_row,ec_last_row) %>%
